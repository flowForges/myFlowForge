import type { Appearance, Terminal, CloseAction } from '@shared/types'
...
export function AppearancePane({ appearance, onChange, terminal, onTerminalChange, closeAction, onCloseActionChange }: AppearancePaneProps) {
