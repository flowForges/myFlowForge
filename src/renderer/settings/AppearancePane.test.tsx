...
const appearance: Appearance = { theme: 'dark', accent: 'blue', vibrancy: false, glass: false, windowOpacity: 1, blurAmount: 0, density: 'comfortable', fontSize: 'medium' }
...
describe('AppearancePane', () => {
  it('reflects current appearance and reports changes', () => {
    ...
    render(<AppearancePane appearance={appearance} onChange={onChange} terminal={terminal} onTerminalChange={() => {}} closeAction="ask" onCloseActionChange={() => {}} />)
  ...
  it('渲染「窗口」关闭行为三选并回写 closeAction', () => {
    ...
    render(<AppearancePane appearance={appearance} onChange={() => {}} terminal={terminal} onTerminalChange={() => {}} closeAction="ask" onCloseActionChange={onCloseActionChange} />)
    // 三个选项都渲染,当前值高亮
  ...
  it('closeAction=hide 时高亮「缩小到 Dock」', () => {
    render(<AppearancePane appearance={appearance} onChange={() => {}} terminal={terminal} onTerminalChange={() => {}} closeAction="hide" onCloseActionChange={() => {}} />)
