...
<img src="assets/screenshots/home.jpg" alt="首页仪表盘 —— 工作区、今日改动与本地时区实时问候,叠加内置壁纸" width="90%" />

<sub><b>首页</b> —— 一眼接续:工作区、在跑的代理、今日改动一目了然。</sub>

<br /><br />

<img src="assets/screenshots/workspace.jpg" alt="工作区 —— 多阶段工作流面板、会话与变更/文件检视" width="90%" />

<sub><b>工作区</b> —— 多阶段工作流面板、按代理的会话、实时变更/文件检视,还有陪你的桌面宠物。</sub>
...
- **🎨 精致且可个性化的 UI** —— 毛玻璃、**6 种主题**（明/暗/跟随系统 + 午夜蓝/暖褐/森林绿）、**12 种强调色**、**内置壁纸库**及你自己的**自定义背景图**（整个应用或仅会话区，可调不透明度）、**应用与会话区可精确到 px 的字号**、按需下载字体、重新设计的首页仪表盘（含本地时区实时问候），可拖宽面板,以及通知中心。
