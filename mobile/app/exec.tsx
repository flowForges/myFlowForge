 ...
 * 阶段和终端留着:阶段在对话里已经有工作流条了;终端是**故意不做**的:
 *   `term:*` 已经进方法表了(2026-09-03),host 那边现在真能开 shell,桌面端连过去就是那台的。
 *   缺的是手机上的终端界面:RN 上没有 xterm,ANSI 解析、回滚、选区、软键盘上那排
 *   Ctrl/Tab/方向键全得自己写 —— 而在手机上敲命令这件事,装个 SSH 客户端比什么都强。
 *
